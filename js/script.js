// Product Database
            ...
            salgados: [
                {
                    ...
                    nome: 'Entreveiro',
                    categoria: 'salgados',
                    descricao: 'Delicioso entreveiro preparado com ingredientes frescos e temperos especiais, ideal para eventos.',
                ...
                },
                {
                    ...
                    nome: 'Maminha',
                    categoria: 'salgados',
                    descricao: 'Maminha suculenta grelhada no ponto, temperada com ervas finas e acompanhamentos especiais.',
                    imagem: 'maminha.jpeg',
                    destaque: true
                },
                {
                    ...
                    categoria: 'salgados',
                    descricao: 'Autêntica paella espanhola com frutos do mar frescos, arroz bomba e açafrão.',
                ...
                },
                {
                    ...
                    categoria: 'salgados',
                    descricao: 'Paella tradicional com carnes brancas selecionadas e vegetais frescos.',
                ...
                },
                {
                    ...
                    categoria: 'salgados',
                    descricao: 'Cremoso risoto de palmito com queijo parmesão e ervas aromáticas.',
            ...
            doces: [
                {
                    ...
                    categoria: 'doces',
                    descricao: 'Delicioso fondue de chocolate com morangos frescos e acompanhamentos variados.',
                ...
                },
                {
                    ...
                    categoria: 'doces',
                    descricao: 'Waffle crocante com banana caramelizada e leite condensado artesanal.',
                ...
                },
                {
                    ...
                    categoria: 'doces',
                    descricao: 'Fondue de chocolate com banana caramelizada e acompanhamentos especiais.',
            ...
            saladas: [
                {
                    ...
                    categoria: 'saladas',
                    descricao: 'Refrescante salada tropical com abacaxi, folhas verdes e molho especial.',
                ...
                },
                {
                    ...
                    categoria: 'saladas',
                    descricao: 'Clássica salada com tomates maduros, cebola roxa e temperos frescos.',
                ...
                },
                {
                    ...
                    categoria: 'saladas',
                    descricao: 'Combinação harmoniosa de três saladas diferentes em uma única porção.',
                ...
                },
                {
                    ...
                    categoria: 'saladas',
                    descricao: 'Variedade ainda maior com quatro tipos de saladas cuidadosamente selecionadas.',
            ...
            productsGrid.innerHTML = products.map(product => `
                <div class="product-card" onclick="showProduct('${product.id}')">
                    <div class="product-image">
                        ${product.imagem || 'Imagem do Produto'}
                    </div>
        ...
        function renderRelatedProducts(products) {
            relatedProducts.innerHTML = products.map(product => `
                <div class="product-card" onclick="showProduct('${product.id}')">
                    <div class="product-image" style="height: 150px; font-size: 0.8rem;">
                        ${product.imagem || 'Imagem'}
                    </div>
                    <div class="product-info" style="padding: 1rem;">
                        <h4 style="font-size: 1rem; margin-bottom: 0.5rem;">${product.nome}</h4>
                        <button class="view-details" style="padding: 0.5rem 1rem; font-size: 0.8rem;">Ver Detalhes</button>
                    </div>
                </div>
            `).join('');
        }
        ...
        function showProduct(productId) {
            ...
            modalImage.textContent = product.imagem || 'Imagem do Produto';
